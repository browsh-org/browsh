...
var LocalHints = {
  getVisibleClickable: function(element) {
    ...
    if (
      ...
      ((role = element.getAttribute("role")) &&
        ((ref5 = role.toLowerCase()) === "button" ||
          ref5 === "tab" ||
          ref5 === "link" ||
          ref5 === "checkbox" ||
          ref5 === "menuitem" ||
          ref5 === "menuitemcheckbox" ||
          ref5 === "menuitemradio")) ||
      ((contentEditable = element.getAttribute("contentEditable")) &&
        ((ref6 = contentEditable.toLowerCase()) === "" ||
          ref6 === "contenteditable" ||
          ref6 === "true"))
    ) {
      isClickable = true;
    }
    ...
    switch (tagName) {
      ...
      case "input":
        isClickable ||
          (isClickable = !(
            ((ref9 = element.getAttribute("type")) != null
              ? ref9.toLowerCase()
              : void 0) === "hidden" ||
            element.disabled ||
      ...
      case "body":
        isClickable ||
          (isClickable =
            ...
            ((ref10 = document.body) != null
              ? ref10.tagName.toLowerCase()
              : void 0) !== "frameset"
              ? (reason = "Frame.")
              : void 0);
      ...
      case "img":
        isClickable ||
          (isClickable =
            (ref11 = element.style.cursor) === "zoom-in" ||
            ref11 === "zoom-out");
        break;
      case "div":
      case "ol":
    ...
    if (
      !isClickable &&
      0 <=
        ((ref12 = element.getAttribute("class")) != null
          ? ref12.toLowerCase().indexOf("button")
          : void 0)
    ) {
  ...
  getLocalHints: function(requireHref) {
    ...
    visibleElements = (function() {
      ...
      results = [];
      for (
        position = k = 0, len1 = visibleElements.length;
        k < len1;
        position = ++k
      ) {
    ...
    (ref1 = DomUtils.getViewportTopLeft()),
      (top = ref1.top),
      (left = ref1.left);
  ...
  generateLinkText: function(hint) {
    ...
    if (nodeName === "input") {
      if (element.labels != null && element.labels.length > 0) {
        ...
        ((ref = element.getAttribute("type")) != null
          ? ref.toLowerCase()
          : void 0) === "file"
      ) {
...
var VimiumNormal = {
    ...
    for (i = j = ref = links.snapshotLength - 1; j >= 0; i = j += -1) {
      ...
      for (k = 0, len = linkStrings.length; k < len; k++) {
        ...
        if (
          ...
          0 <=
            ((ref1 = link.value) != null
              ? typeof ref1.indexOf === "function"
                ? ref1.indexOf(linkString)
                : void 0
              : void 0)
        ) {
          linkMatches = true;
  ...
  focusInput: function(count) {
    var element,
      ...
      tuple,
      visibleInputs;
    resultSet = DomUtils.evaluateXPath(
      textInputXPath,
      XPathResult.ORDERED_NODE_SNAPSHOT_TYPE
    );
